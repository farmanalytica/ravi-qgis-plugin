...
class RAVIDialog(QDialog, FORM_CLASS):
    ...
    def aoi_checked_function(self):
        ...
        if self.aoi_checked and self.folder_set:
            ...
            self.QPushButton_aglgis.setEnabled(True)
            ...
            self.QPushButton_aglgis.setEnabled(False)
            ...
            def sysi_processing(self, imageToDownload):
                ...
                try:
                    ...
                    try:
                        ...
                        band_names = ["Blue", "Green", "Red", "Rededge2", "NIR", "SWIR1", "SWIR2", "NDVI", "NBR2"]
    ...
    def open_aglgis(self):
        from .modules.aglgis_dialog import AglgisDialog

        dialog = getattr(self, "_aglgis_dialog", None)

        if dialog is None:
            dialog = AglgisDialog(self, iface=qgis.utils.iface)
            self._aglgis_dialog = dialog
